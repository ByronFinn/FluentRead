 ...
 * 主要内容：缓存 ContentScriptContext，维护 mountRequestId、实例与 Shadow UI 句柄；划词翻译与 Harness 共用 closed Shadow Root，通过 modal host 控制器承接组件选区，并在两个入口都关闭或请求过期时恢复 DOM 所有权并移除。
